...
- **Reparo Rápido**: Gastando uma ação para cada classe de tamanho e com ferramentas apropriadas em mãos, consegue reparar danos a armas ou ferramentas à até 1/2 da sua vida máxima (teste de criar);
- **Mão Hábeis**: Recebe vantagem em testes de **Criar** para fazer coisas de ferro, aço, bronze ou qualquer outro metal / liga metálica ferrosos;