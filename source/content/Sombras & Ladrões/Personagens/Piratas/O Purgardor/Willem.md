...
## Aparência
Homem de altura mediana e pele pálida avermelhada pelo sol, não aparenta ser muito forte. Suas mãos são largas e cheias de calo. Sempre veste calças de algodão, um sobretudo de seda e um lenço enrolado ao pescoço. Seu pé direito é uma perna de pau pois não tem este pé. 
...
#### lista de músicas
- [Nica Libre At Dusk - Ben Howard](https://youtu.be/NzcV8HXE_EI)
- [Promise - Ben Howard](https://youtu.be/9iTGrGPu2U4)
- [Under The Same Sun - Ben Howard](https://youtu.be/HnL259j-tDc)
- [I Don't See you Coming Back - Alex Radice](https://youtu.be/RtpcC5YtvzU)

## Ficha
### Atributos

| **Força**        | 12  | Inteligência      | 10  | Movimento   | 5   |
| ---------------- | --- | ----------------- | --- | ----------- | --- |
| **Destreza**     | 9   | **Educação**      | 6   | **Saltar**  | 2   |
| **Constituição** | 14  | **Empatia**       | 16  | **Pular**   | 1   |
| **Tamanho**      | 9   | **Auto Controle** | 15  | **Escalar** | 2   |
### Status
